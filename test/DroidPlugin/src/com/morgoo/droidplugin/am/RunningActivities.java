...
public class RunningActivities {
    ...
    private static Map<Activity, RunningActivityRecord> mRunningActivityList = new HashMap<Activity, RunningActivityRecord>();
    private static Map<Integer, RunningActivityRecord> mRunningSingleStandardActivityList = new HashMap<Integer, RunningActivityRecord>();
    private static Map<Integer, RunningActivityRecord> mRunningSingleTopActivityList = new HashMap<Integer, RunningActivityRecord>();
    private static Map<Integer, RunningActivityRecord> mRunningSingleTaskActivityList = new HashMap<Integer, RunningActivityRecord>();
    private static Map<Integer, RunningActivityRecord> mRunningSingleInstanceActivityList = new HashMap<Integer, RunningActivityRecord>();
    ...
    private static void doFinshIt(Map<Integer, RunningActivityRecord> runningActivityList) {
        if (runningActivityList != null && runningActivityList.size() >= PluginManager.STUB_NO_ACTIVITY_MAX_NUM - 1) {
            List<RunningActivityRecord> activitys = new ArrayList<RunningActivityRecord>(runningActivityList.size());
